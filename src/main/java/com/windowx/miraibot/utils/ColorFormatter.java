...
public class ColorFormatter {
    ...
    public static String formatColor(String str, char color) {
        return toANSI(translateAlternateColorCodes(str, color));
    }

    public static String translateAlternateColorCodes(String message, char color) {
    ...
    public static String stripColors(String message) {
        return message.replaceAll("(&([a-fk-or0-9]))","")
                .replaceAll("(§([a-fk-or0-9]))","")
                .replaceAll("s/\\x1b\\[[0-9;]*[a-zA-Z]//g","");
    }
}
