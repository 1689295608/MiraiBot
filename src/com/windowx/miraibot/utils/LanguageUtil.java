	...
	public static byte[] languageFile(String language) {
		if (language.equals("zh")) {
			return ("# 中文（简体）\n" +
					...
					"not.friend=你没有这个好友！\n" +
					"not.qq=$1 不是一个 QQ！\n" +
					"time.too.long=禁言时间 $1 太长了\n" +
					"usage=语法\n" +
					"language=语言\n" +
					"file.error=该文件不存在！\n" +
					"group.id.not.found=群 ID $1 未找到, 请确保已填入配置文件？\n" +
			...
			return ("# 中文（繁體）\n" +
					...
					"not.friend=你沒有這個好友！\n" +
					"not.qq=$1 不是一個 QQ！\n" +
					"time.too.long=禁言時間 $1 太長了\n" +
					"usage=語法\n" +
					"language=語言\n" +
					"file.error=該文件不存在！\n" +
					"group.id.not.found=群 ID $1 未找到, 請確保已填入配置文件？\n" +
			...
			return ("# English (" + language + ")\n" +
					...
					"login.success=Login successful, your nickname is: $1\n" +
					...
					"not.qq=$1 is not a QQ number!\n" +
					"time.too.long=Mute time $1 is too long\n" +
					"usage=Usage\n" +
					"language=Language\n" +
					"file.error=The file does not exist!\n" +
					"group.id.not.found=Group ID $1 is not found, please make sure to fill in the configuration file?\n" +
					...
					"member.mute=$1 ($2) was muted by $3 ($4) for $5 seconds!\n" +
					"open=turned on\n" +
					"off=turned off\n" +
					"mute.all=Mute all \n" +
					...
					"recall.message=$1 recalled a [$2] message\n" +
					"recall.unknown.message=$1 recalled a message\n" +
